...
class Lista {
  ...
  // O HASH SO USA OS METODOS PESQUISAR E INSERIR DA LISTA, ENTAO FOI REMOVIDO OS
  // QUE NAO FORAM UTILIZADOS
...
public class hashindi {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SerieHashINDIRETOLISTA nt = new SerieHashINDIRETOLISTA();
    ...
    while (!(entrada.equals("FIM"))) {
      ...
      ha.inserirInicio(valorinserirHash);
      entrada = MyIO.readLine();
